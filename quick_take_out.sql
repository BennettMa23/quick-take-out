/*
 ...
 Source Server         : centos7  1.198
 Source Server Type    : MySQL
 Source Server Version : 80027
 Source Host           : 10.10.1.198:3306
 Source Schema         : quick_take_out

 Target Server Type    : MySQL
 Target Server Version : 80027
 File Encoding         : 65001

 Date: 06/09/2023 08:46:40
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '菜品及套餐分类' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 74 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '菜品' ROW_FORMAT = Dynamic;
...
INSERT INTO `dish` VALUES (49, '米饭', 12, 2.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/76752350-2121-44d2-b477-10791c23a8ec.png', '精选五常大米', 0, '2022-06-10 09:30:17', '2023-08-23 11:43:25', 1, 1);
...
INSERT INTO `dish` VALUES (51, '老坛酸菜鱼', 20, 56.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/4a9cefba-6a74-467e-9fde-6e687ea725d7.png', '原料：汤，草鱼，酸菜', 0, '2022-06-10 09:40:51', '2023-08-24 11:11:31', 1, 1);
...
INSERT INTO `dish` VALUES (70, '大龙虾', 12, 36.00, 'http://10.10.1.198:9000/quick-itcast/546535c5-1388-43fa-9028-8b92d6d98f13.jpg', '新鲜龙虾', 1, '2023-08-23 11:36:29', '2023-08-23 11:36:55', 1, 1);
INSERT INTO `dish` VALUES (72, '测试2', 18, 222.00, 'http://10.10.1.198:9000/quick-itcast/0f9454bb-831d-4de9-a88a-9fae7345bd0f.JPG', '', 1, '2023-08-23 15:20:48', '2023-08-23 15:31:16', 1, 1);
INSERT INTO `dish` VALUES (73, '测试3', 11, 21.00, 'http://10.10.1.198:9000/quick-itcast/8e7bf88a-ad97-4054-bae3-cb5930580d83.JPG', '', 0, '2023-08-23 15:21:02', '2023-08-23 15:51:32', 1, 1);
INSERT INTO `dish` VALUES (74, '新鲜事件', 16, 12.00, 'http://10.10.1.198:9000/quick-itcast/4fe3edfa-d2b2-4bef-94af-6b71c0a7bd8c.JPG', '好', 1, '2023-08-23 15:21:13', '2023-08-24 10:16:55', 1, 1);
...
CREATE TABLE `dish_flavor`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '菜品口味关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `dish_flavor` VALUES (104, 70, '辣度', '[\"微辣\",\"中辣\",\"重辣\"]');
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '管理员', 'admin', '207cf410532f92a47dee245ce9b11ff71f578ebd763eb3bbea44ebd043d018fb', '13812312312', '1', '110101199001010047', 1, '2022-02-15 15:51:20', '2022-02-17 09:16:20', 10, 1);
INSERT INTO `employee` VALUES (2, '张三三', 'zhangsan', '207cf410532f92a47dee245ce9b11ff71f578ebd763eb3bbea44ebd043d018fb', '13544441111', '1', '124563199911011245', 0, '2023-08-23 08:36:33', '2023-08-23 08:37:27', 1, 1);
INSERT INTO `employee` VALUES (3, '李四', 'lisi', '207cf410532f92a47dee245ce9b11ff71f578ebd763eb3bbea44ebd043d018fb', '14511114444', '0', '124563111144552145', 1, '2023-08-23 08:36:52', '2023-08-23 08:36:52', 1, 1);
...
-- Records of setmeal
-- ----------------------------
INSERT INTO `setmeal` VALUES (33, 13, '测试1', 65.00, 0, '', 'http://10.10.1.198:9000/quick-itcast/4bc48e59-263a-46b9-894e-36d6efc900cd.JPG', '2023-08-24 11:09:58', '2023-08-24 11:11:42', 1, 1);
...
CREATE TABLE `setmeal_dish`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '套餐菜品关系' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of setmeal_dish
-- ----------------------------
INSERT INTO `setmeal_dish` VALUES (57, 33, 54, '清炒小油菜', 18.00, 2);
INSERT INTO `setmeal_dish` VALUES (58, 33, 51, '老坛酸菜鱼', 56.00, 1);
